...
public interface HermesSystemConstants {
    ...
    String SEND_SMS_REQUEST_THROUGH_ASYNC_ROUTE = ASYNCAPI_ROUTE_PREFIX + SEND_SMS_REQUEST_ROUTE_PREFIX;
    String DIRECT_TO_SEND_SMS_REQUEST_THROUGH_ASYNC_ROUTE = "direct:" + SEND_SMS_REQUEST_THROUGH_ASYNC_ROUTE;
    String SEND_SMS_THROUGH_HTTP_INTERFACE = RESTAPI_ROUTE_PREFIX + SEND_SMS_REQUEST_ROUTE_PREFIX;
    String DIRECT_TO_SEND_SMS_THROUGH_HTTP_INTERFACE = "direct:" + SEND_SMS_THROUGH_HTTP_INTERFACE;
    ...
    String SMPP_REPOSITORY_ROUTE_PREFIX = INTERNAL_ROUTE_PREFIX + "SMPP_CONNECTION_REPOSITORY";
