...
public interface HermesSystemConstants {
    ...
    String SMPP_DECIDER_ROUTE = INTERNAL_ROUTE_PREFIX + "_GET_TARGET_FROM_POLICIES";
    ...
    // POLICY ROUTES(S)
    String READ_POLICIES_FROM_DATASOURCE_ROUTE = SYSTEM_ROUTE_PREFIX + "_POLICY_READ";
    String DIRECT_TO_READ_POLICIES_FROM_DATASOURCE_ROUTE = "direct:" + READ_POLICIES_FROM_DATASOURCE_ROUTE;
    String UPDATE_POLICIES_ON_DATASOURCE_ROUTE = SYSTEM_ROUTE_PREFIX + "_POLICY_UPDATE";
