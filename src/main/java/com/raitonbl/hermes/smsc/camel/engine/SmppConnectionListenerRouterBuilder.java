...
public  class SmppConnectionListenerRouterBuilder extends RouteBuilder {
    public static final String ROUTE_ID = CamelConstants.SYSTEM_ROUTE_PREFIX +"PDU_LISTENER";
    ...
    public final static String UNSUPPORTED_PDU_EVENT = String.format(
            ...
            SmppConstants.MESSAGE_TYPE, CamelConstants.MESSAGE_RECEIVED_BY, SmppConstants.ID
    );
    public final static String RECEIVED_SMS_PDU_EVENT = String.format(
            ...
            SmppConstants.MESSAGE_TYPE, CamelConstants.MESSAGE_RECEIVED_BY, SmppConstants.ID, SmppConstants.MESSAGE_STATE
    );
    ...
    public void configure() throws Exception {
        ...
        from("direct:" + ROUTE_ID)
                ...
                .log(LoggingLevel.DEBUG, "smpp.PduEvent received from Smpp{\"name\":\"${headers." + CamelConstants.MESSAGE_RECEIVED_BY + "}\"}")
                .choice()
    ...
    private void toSmsRequest(Exchange exchange) throws Exception {
        ...
        target.setSmpp(exchange.getIn().getHeader(CamelConstants.MESSAGE_RECEIVED_BY, String.class));
