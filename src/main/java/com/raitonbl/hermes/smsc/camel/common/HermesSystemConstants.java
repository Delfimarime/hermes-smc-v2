...
public interface HermesSystemConstants {
    ...
    String POLICY_LIFECYCLE_MANAGER = SYSTEM_ROUTE_PREFIX + "POLICY_MANAGE_LIFECYCLE";

    // SMPP CONNECTION ROUTE(S)
    String SMPP_CONNECTION_LIFECYCLE_MANAGER = SYSTEM_ROUTE_PREFIX + "SMPP_CONNECTION_MANAGE_LIFECYCLE";
    ...
    String SMPP_CONNECTION_TRANSCEIVER_CALLBACK_FORMAT = HermesSystemConstants.SYSTEM_ROUTE_PREFIX + "%s_TRANSCEIVER_CALLBACK";
    ;
